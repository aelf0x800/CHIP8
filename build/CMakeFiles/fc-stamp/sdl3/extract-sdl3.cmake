...
#
get_filename_component(filename "/home/a/Desktop/CHIP8/build/_deps/sdl3-tmp/SDL3-3.2.8.zip" ABSOLUTE)
get_filename_component(directory "/home/a/Desktop/CHIP8/build/_deps/sdl3-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-sdl3${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-sdl3${i}")
